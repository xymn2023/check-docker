...
for name in ('install.sh','uninstall.sh','core.py','container_update.py','docker_api.py','autoupdate_bot.py','admin.py','dependency_env.py','requirements.txt','requirements.lock'):
